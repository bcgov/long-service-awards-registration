 ...
 * @param {array} category Optional. Required in nested errors. Names of error item within object - dependent on delegated or personal.
...
export default function getFormErrorMessage(
  ...
  const nestedError =
    errors[category] && errors[category][optionname] ? true : false;
